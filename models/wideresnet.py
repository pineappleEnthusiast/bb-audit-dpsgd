...
"""WideResNet 16-4 with GroupNorm (group_size=16)
    This implementation follows the standard WideResNet architecture with:
    - Depth: 16 (6n+4 where n=2)
    - Width: 4 (widen factor)
    - GroupNorm with group size 16 instead of BatchNorm
    """
import torch
...
class WideResNet(nn.Module):
    ...
    Args:
        ...
        widen_factor: Width factor for the network (default: 4)
        dropRate: Dropout rate (default: 0.0)
    """
    def __init__(self, input_shape, out_dim, widen_factor=4, dropRate=0.0):
