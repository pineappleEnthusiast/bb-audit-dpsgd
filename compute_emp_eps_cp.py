...
def main():
    ...
    experiments = [
        ("Purchase", "non_private_audits_rerun/purchase_defense_non_private/purchase_mlp_epsNone"),
        ("Purchase", "non_private_audits_rerun/purchase_no_defense_non_private/purchase_mlp_epsNone"),
    ]
    # ============================================
